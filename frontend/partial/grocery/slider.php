...
<?php
    $strSliderData = file_get_contents($datasource.'grocery/slider.json');
    $arrSliderData = json_decode($strSliderData);
    // dd($arrSliderData);
?>


    <div id="carouselExampleCaptions2" class="carousel slide" style="margin: 3% 21%; width:61%;">
        <div class="carousel-indicators">
            ...
            ?>
            <button type="button" data-bs-target="#carouselExampleCaptions2" data-bs-slide-to="<?=$key?>" class="<?=$active?>" aria-current="true" aria-label="Slide 1"></button>
            <?php
                endforeach
            ?>
        </div>
